	...
	<div class="container">
		...
		<form method="post" action="P_bomController" class="form">
			<div class="form-fields">
				<div class="form-row">
					<label for="상품고유번호_원자재">상품고유번호_원자재<span>*</span></label> <input
						type="text" name="p_sku" id="skuidmaterial"> <label
						for="소모량">소모량<span>*</span></label> <input type="text"
						name="p_sku1" id="consumption">
				</div>

				<div class="form-row">
					<label for="상품고유번호">상품고유번호<span>*</span></label> <input type="text"
						name="p_sku2" id="skuid"> <label for="작업표준서">작업표준서<span>*</span></label>
