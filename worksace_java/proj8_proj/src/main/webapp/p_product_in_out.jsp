...
<div class="container">
    <h1>◎ 완제품입고관리</h1>
    <span>* 모두 기입</span>
    <form method="post" action="P_product_in_outController" class="form">
        <div class="form-fields">
            <div class="form-row">
                <label for="완제품수량">완제품수량<span>*</span></label>
                <input type="text" name="p_sku" id="productcount">
...
function searchSkus() {
   ...
   if (searchKeyword.trim() === "") {
       // 검색어가 없을 경우 전체 목록 조회
       window.location.href = "P_product_in_outController";
   } else {
       // 검색어가 있을 경우 검색 결과 조회
       window.location.href = "P_product_in_outController?searchKeyword=" + searchKeyword;
   }
}
   ...
   function updateSku() {
       ...
       fetch('P_product_in_outController', {
           method: 'POST',
           headers: {
