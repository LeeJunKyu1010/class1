...
//	String[] menu;	// 메뉴들
//	int[] price;	// 메뉴와 순서를 받춰서 관리하는 가격들
	
	
	ArrayList menu;	// 메뉴들
	ArrayList price;	// 메뉴와 순서를 받춰서 관리하는 가격들
	
	int seedMoney;	// 권리금
	
	Kimbap(int seedMoney){
		System.out.println("Kimbap(int) 생성자 실행");
...
//		for(int i=0; i<this.menu.size(); i++)
	...
	void addMenu(String menuName, int menuPrice) {
		...
		System.out.println("메뉴 "+menuName+"("+menuPrice+")(을)를 추가하였습니다.");
	}
