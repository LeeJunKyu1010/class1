...
<body>
	...
	<form method="get" action="req">
		...
		<input type="checkbox" name="checkbox1" value="checkbox12">체크2
		<input type="checkbox" name="checkbox1" value="checkbox13">체크3<br>
		...
		<span name="span1" value="span11">span</span>
