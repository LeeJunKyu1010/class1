...
<body>
	<div id="mainbox">
		<div id="logo">
			<img src="img/GKBM_logo.png" alt="GKBM MES SYSTEM">
		</div>
		...
		<form action="login" method="post">
			...
			<input type="submit" class="login" value="로그인"> <input
				type="button" class="find_id" value="아이디찾기"
				onclick="alert('관리자에게 문의 바랍니다.')"> <input type="button"
				class="find_pw" value="비밀번호찾기" onclick="alert('관리자에게 문의 바랍니다.')">
