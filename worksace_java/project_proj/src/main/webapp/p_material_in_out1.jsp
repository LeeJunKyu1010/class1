...
<body>
	<div class="container">
		<h1>◎ 원자재출고관리</h1>
		<span>* 모두 기입</span>
		<form method="post" action="P_material_in_out1Controller" class="form">
			<div class="form-fields">
				<div class="form-row">
					<label for="원자재수량">원자재수량<span>*</span></label> <input type="text"
						name="p_sku" id="materialcount"> <label for="원자재가격">원자재가격<span>*</span></label>
				...
				<div class="form-row">
					<label for="상품고유번호">상품고유번호<span>*</span></label> <input type="text"
						name="p_sku4" id="skuid"> <label for="등록번호">등록번호<span>*</span></label>
